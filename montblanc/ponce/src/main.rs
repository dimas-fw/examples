...
fn tagus_callback(ctx: &ContextImpl<AgentProps>, message: Message) -> Result<()> {
...
fn missouri_callback(ctx: &ContextImpl<AgentProps>, message: Message) -> Result<()> {
...
fn brazos_callback(ctx: &ContextImpl<AgentProps>, message: Message) -> Result<()> {
...
fn ohio_callback(ctx: &ContextImpl<AgentProps>, message: Message) -> Result<()> {
...
fn volga_callback(ctx: &ContextImpl<AgentProps>, message: Message) -> Result<()> {
